...
class MyPreferenceTool(BaseTool):
  ...
  description = (
    "Useful for when you want to get information about my movie preference. The Input should be a question to deduce movie preference. The Input should be a question to deduce movie preference"
  )
